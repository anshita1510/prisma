    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      `}>
        ...
        <nav className="flex-1 space-y-2 overflow-y-auto pr-1">
          ...
          <NavItem icon={<UserPlus size={20} />} label="Create" isActive={activeTab === 'Create User'} onClick={() => {  router.push("/dashboard-superadmin/create-user"), setActiveTab('Create User'); setIsOpen(false); }} />
