  ...
  return (
    ...
    */
    <div className="w-full p-6 pt-20 lg:pt-6 bg-gray-50  flex items-start justify-center">
      ...
      <div className="relative w-full max-w-6xl h-[160px] md:h-[220px] overflow-hidden bg-emerald-950 shadow-md rounded-2xl group">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-emerald-900/80 via-emerald-800/60 to-transparent mix-blend-multiply"></div>
        ...
        >
          <div className="w-8 h-1 bg-green-400 mb-3 rounded-full"></div>
          
          <h1 className="text-white font-bold tracking-tight text-2xl sm:text-3xl md:text-4xl lg:text-5xl mb-1">
            Welcome User
          </h1>
          
          <p className="text-green-50/80 text-xs md:text-base font-medium tracking-wide max-w-md line-clamp-1 md:line-clamp-none">
            Great to see you again. Here's your daily overview.
          </p>
