...
const FEATURES = {
  people: {
    ...
    preview: {
      ...
      about: "Visualize employee data, trends, and reports to make smarter HR decisions."
    }
  },
  payroll: {
    ...
    preview: {
      ...
      about: "Manage salaries, deductions, reimbursements, and payslips with full compliance."
    }
  },
  performance: {
    ...
    preview: {
      name: "Performance",
      role: "Goals & Reviews",
      about: "Track OKRs, reviews, and continuous feedback to improve team performance."
    }
  },
  hiring: {
    ...
    preview: {
      name: "Hiring",
      role: "Recruitment",
      about: "Streamline hiring, offers, and onboarding journeys for new employees."
    }
  }
};

export default function OurWorkSection() {
  // ✅ FIX: Define the state to only accept keys from the FEATURES object
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6">
            {/* ✅ FIX: Cast the keys array to the specific type of keys in FEATURES */}
