...
export default function OurWorkSection() {
  // ✅ FIX 1: Defined state type so it knows which keys are valid
    ...
    <section className="bg-gray-50 py-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {/* ✅ FIX 2: Added type cast to the keys array so 'key' is not just a generic string */}
        ...
        <div className="bg-white rounded-2xl shadow-lg p-10 max-w-4xl mx-auto">
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {/* ✅ FIX 3: Added (point: string) to explicitly type the map parameter */}
            {current.content.points.map((point: string, index: number) => (
              <li
                key={index}
